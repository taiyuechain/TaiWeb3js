...
var tests = [
    {
        ...
        // signature from tai_signTransaction
    ...
    describe("accounts", function () {
        ...
        tests.forEach(function (test, i) {
            if (test.error) {
                ...
                it("signTransaction must compare to tai_signTransaction", function(done) {
                    var ethAccounts = new Accounts();
                ...
                it("signTransaction using the iban as \"to\" must compare to tai_signTransaction", function(done) {
                    var ethAccounts = new Accounts();
                ...
                it("signTransaction will call for nonce", function(done) {
                    ...
                    provider.injectValidation(function (payload) {
                        ...
                        assert.equal(payload.method, 'tai_getTransactionCount');
